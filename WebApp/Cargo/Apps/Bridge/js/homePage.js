...
var HomePage = function () {
    ...
    server.fileManager.attach(this, ChangeThemeEvent, function (evt, HomePage) {
        ...
        changePropertyByClassName("color", ".entity_panel_header", "." + evt.dataMap.themeClass + " .ace_gutter")
        ...
        changePropertyByClassName("background-color", ".filter_panel_buttons input", "." + evt.dataMap.themeClass)
        changePropertyByClassName("background", ".filter_panel_buttons input", "." + evt.dataMap.themeClass)
        changePropertyByClassName("color", ".filter_panel_buttons input", "." + evt.dataMap.themeClass)
