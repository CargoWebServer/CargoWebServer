        ...
        function(item_supplier, caller){
            server.entityManager.getEntityByUuid(item_supplier.M_package, false, 
                function(item_package,caller){
                    ...
                    .appendElement({"tag" : "img", "class" : "img-fluid rounded", "id"  :item_package.M_id  + "-image"}).up()
                    ...
                    parseFirstImage(item_package.M_id, mainPage.adminPage.adminOrderPage.panel.getChildById(item_package.M_id + "-image"))
