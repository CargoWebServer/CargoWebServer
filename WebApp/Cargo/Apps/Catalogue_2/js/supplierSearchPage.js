        ...
        function(localisation, caller){
            ...
            if(localisation.M_parent != ""){
                ...
                for(var i=0; i < caller.localisations.length; i++){
                    ...
                    .appendElement({"tag" : "a", "href" : "#", "innerHtml" : caller.localisations[i].M_name}).down()
                    
                    // generic onclick wiht localisation.
                    lnk.element.onclick = function(onClick, localisation){
                        return function(){
                            // call the onclick function.
                            onClick(localisation)
                        }
                    }(caller.onClick, caller.localisations[i])
                ...
                server.entityManager.getEntityByUuid(result.M_inventoried[i], false,
                    function(inventory, body){
                        ...
                        tr.appendElement({"tag":"td"}).down().appendElement({"tag":"tbody"}).down()
                            ...
                            displayLocalisation(locTd, inventory.M_located, function(l){
                                console.log(l)
                            })
                    },
                    function(){
