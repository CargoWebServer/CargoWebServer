...
ItemDisplayPage.prototype.displayTabItem = function (item, callback) {
    ...
    this.itemResultPanel.appendElement({"tag" : "div","class" : "tab-pane fade show result-tab-content", "style" : "position:relative; background-color : white;", "id" : item.M_id + "-itemquery", "role" : "tabpanel", "aria-labelledby" :item.M_id + "-tab" }).down()
