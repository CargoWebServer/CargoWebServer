...
QT_MOC_LITERAL(1, 8, 20), // "processBinaryMessage"
QT_MOC_LITERAL(2, 29, 0), // ""
QT_MOC_LITERAL(3, 30, 12), // "disconnected"
QT_MOC_LITERAL(4, 43, 26), // "completeProcessMessageData"
QT_MOC_LITERAL(5, 70, 32) // "com::mycelius::message::Message*"

    },
    "Session\0processBinaryMessage\0\0"
    "disconnected\0completeProcessMessageData\0"
...
void Session::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->processBinaryMessage((*reinterpret_cast< QByteArray(*)>(_a[1]))); break;
        case 1: _t->disconnected(); break;
        case 2: _t->completeProcessMessageData((*reinterpret_cast< com::mycelius::message::Message*(*)>(_a[1]))); break;
        default: ;
        }
    }
}
