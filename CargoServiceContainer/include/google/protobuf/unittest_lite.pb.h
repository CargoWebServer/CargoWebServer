...
class TestDeprecatedLite : public ::google::protobuf::MessageLite {
 public:
  ...
  bool has_deprecated_field() const PROTOBUF_DEPRECATED;
  void clear_deprecated_field() PROTOBUF_DEPRECATED;
  static const int kDeprecatedFieldFieldNumber = 1;
  ::google::protobuf::int32 deprecated_field() const PROTOBUF_DEPRECATED;
  void set_deprecated_field(::google::protobuf::int32 value) PROTOBUF_DEPRECATED;
...
class TestEmptyMessageLite : public ::google::protobuf::MessageLite {
 public:
...
class TestEmptyMessageWithExtensionsLite : public ::google::protobuf::MessageLite {
 public:
