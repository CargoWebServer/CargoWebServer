...
class RepeatedWellKnownTypes : public ::google::protobuf::Message {
 public:
...
class OneofWellKnownTypes : public ::google::protobuf::Message {
 public:
  OneofWellKnownTypes();
...
class MapWellKnownTypes : public ::google::protobuf::Message {
 public:
  MapWellKnownTypes();
