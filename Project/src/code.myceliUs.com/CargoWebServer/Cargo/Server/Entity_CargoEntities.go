...
func (this *EntityManager) create_CargoEntities_LogEntryEntityPrototype() {
	...
	logEntryEntityProto.FieldsType = append(logEntryEntityProto.FieldsType,"xs.int64")
...
func (this *EntityManager) create_CargoEntities_TextMessageEntityPrototype() {
	...
	textMessageEntityProto.FieldsType = append(textMessageEntityProto.FieldsType,"xs.int64")
...
func (this *EntityManager) create_CargoEntities_SessionEntityPrototype() {
	...
	sessionEntityProto.FieldsType = append(sessionEntityProto.FieldsType,"xs.int64")
...
func (this *EntityManager) create_CargoEntities_FileEntityPrototype() {
	...
	fileEntityProto.FieldsType = append(fileEntityProto.FieldsType,"xs.int64")
	...
	fileEntityProto.FieldsType = append(fileEntityProto.FieldsType,"xs.bool")
		...
		/** entities **/
 		if results[0][5] != nil{
			...
			if err!=nil{
				...
				if typeName == "CargoEntities.Group"{
						if len(uuids[i]) > 0 {
