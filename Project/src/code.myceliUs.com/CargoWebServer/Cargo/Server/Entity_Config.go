...
func (this *Config_DataStoreConfigurationEntity) SaveEntity() {
	...
	} else if this.object.M_dataStoreType == Config.DataStoreType_MEMORY_STORE {
	...
	} else if this.object.M_dataStoreType == Config.DataStoreType_GRAPH_STORE {
	...
	if len(results) > 0 {
		...
		if results[0][3] != nil {
			...
			if enumIndex == 0 {
				...
				this.object.M_dataStoreType = Config.DataStoreType_MEMORY_STORE
			} else if enumIndex == 2 {
				this.object.M_dataStoreType = Config.DataStoreType_KEY_VALUE_STORE
			} else if enumIndex == 3 {
				this.object.M_dataStoreType = Config.DataStoreType_GRAPH_STORE
			}
		}
