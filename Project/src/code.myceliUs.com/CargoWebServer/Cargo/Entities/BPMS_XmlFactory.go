...
/** inititialisation of RessourceInstance **/
func (this *BPMS_XmlFactory) InitRessourceInstance(xmlElement *BPMS.XsdRessourceInstance, object *BPMS.RessourceInstance) {
	log.Println("Initialize RessourceInstance")
	if len(object.UUID) == 0 {
		object.UUID = "BPMS.RessourceInstance%" + Utility.RandomUUID()
	}

	/** Init ressourceParameterInstance **/
	object.M_parameters = make([]*BPMS.RessourceParameterInstance, 0)
	for i := 0; i < len(xmlElement.M_parameters); i++ {
		val := new(BPMS.RessourceParameterInstance)
		this.InitRessourceParameterInstance(xmlElement.M_parameters[i], val)
		object.M_parameters = append(object.M_parameters, val)
...
/** inititialisation of RessourceParameterInstance **/
func (this *BPMS_XmlFactory) InitRessourceParameterInstance(xmlElement *BPMS.XsdRessourceParameterInstance, object *BPMS.RessourceParameterInstance) {
	log.Println("Initialize RessourceParameterInstance")
	if len(object.UUID) == 0 {
		object.UUID = "BPMS.RessourceParameterInstance%" + Utility.RandomUUID()
	}

	/** Init dataRef **/
	if xmlElement.M_data != nil {
		object.M_data = new(BPMS.ItemAwareElementInstance)
		this.InitItemAwareElementInstance(xmlElement.M_data, object.M_data)
...
func (this *BPMS_XmlFactory) InitSubprocessInstance(xmlElement *BPMS.XsdSubprocessInstance, object *BPMS.SubprocessInstance) {
	...
	/** Init ressourceInstance **/
	object.M_ressources = make([]*BPMS.RessourceInstance, 0)
	for i := 0; i < len(xmlElement.M_ressources); i++ {
		val := new(BPMS.RessourceInstance)
		this.InitRessourceInstance(xmlElement.M_ressources[i], val)
		object.M_ressources = append(object.M_ressources, val)
...
func (this *BPMS_XmlFactory) SerialyzeSubprocessInstance(xmlElement *BPMS.XsdSubprocessInstance, object *BPMS.SubprocessInstance) {
	...
	/** Serialyze RessourceInstance **/
	if len(object.M_ressources) > 0 {
		xmlElement.M_ressources = make([]*BPMS.XsdRessourceInstance, 0)
	}

	/** Now I will save the value of ressources **/
	for i := 0; i < len(object.M_ressources); i++ {
		xmlElement.M_ressources = append(xmlElement.M_ressources, new(BPMS.XsdRessourceInstance))
		this.SerialyzeRessourceInstance(xmlElement.M_ressources[i], object.M_ressources[i])
	}
...
/** serialysation of RessourceInstance **/
func (this *BPMS_XmlFactory) SerialyzeRessourceInstance(xmlElement *BPMS.XsdRessourceInstance, object *BPMS.RessourceInstance) {
	if xmlElement == nil {
		return
	}

	/** Serialyze RessourceParameterInstance **/
	if len(object.M_parameters) > 0 {
		xmlElement.M_parameters = make([]*BPMS.XsdRessourceParameterInstance, 0)
	}

	/** Now I will save the value of parameters **/
	for i := 0; i < len(object.M_parameters); i++ {
		xmlElement.M_parameters = append(xmlElement.M_parameters, new(BPMS.XsdRessourceParameterInstance))
		this.SerialyzeRessourceParameterInstance(xmlElement.M_parameters[i], object.M_parameters[i])
	}
...
/** serialysation of ItemAwareElementInstance **/
func (this *BPMS_XmlFactory) SerialyzeItemAwareElementInstance(xmlElement *BPMS.XsdItemAwareElementInstance, object *BPMS.ItemAwareElementInstance) {
	if xmlElement == nil {
		return
	}
...
/** serialysation of RessourceParameterInstance **/
func (this *BPMS_XmlFactory) SerialyzeRessourceParameterInstance(xmlElement *BPMS.XsdRessourceParameterInstance, object *BPMS.RessourceParameterInstance) {
	if xmlElement == nil {
		return
	}

	/** Serialyze ItemAwareElementInstance **/
	if object.M_data != nil {
		xmlElement.M_data = new(BPMS.XsdItemAwareElementInstance)
	}

	/** Now I will save the value of data **/
	if object.M_data != nil {
		this.SerialyzeItemAwareElementInstance(xmlElement.M_data, object.M_data)
	}
