...
func (this *OAuth2Configuration) SetNeedSave(needSave bool) {
	this.needSave = needSave
}

func (this *OAuth2Configuration) GetReferenced() []string {
...
func (this *OAuth2Configuration) SetReferenced(uuid string, field string) {
	if this.Referenced == nil {
		this.Referenced = make([]string, 0)
	}
...
func (this *OAuth2Configuration) RemoveReferenced(uuid string, field string) {
	if this.Referenced == nil {
		return
	}
...
func (this *OAuth2Configuration) AppendAllowedAuthorizeTypes(val string) {
	if this.M_allowedAuthorizeTypes == nil {
		this.M_allowedAuthorizeTypes = make([]string, 0)
	}
...
func (this *OAuth2Configuration) AppendAllowedAccessTypes(val string) {
	if this.M_allowedAccessTypes == nil {
		this.M_allowedAccessTypes = make([]string, 0)
	}
