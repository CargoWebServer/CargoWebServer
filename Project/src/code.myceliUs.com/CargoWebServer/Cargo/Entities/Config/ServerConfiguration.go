...
func (this *ServerConfiguration) SetNeedSave(needSave bool){
	this.needSave=needSave
}

func (this *ServerConfiguration) GetReferenced() []string {
...
func (this *ServerConfiguration) SetReferenced(uuid string, field string) {
	if this.Referenced == nil {
		this.Referenced = make([]string, 0)
	}
...
func (this *ServerConfiguration) RemoveReferenced(uuid string, field string) {
	if this.Referenced == nil {
		return
	}
...
func (this *ServerConfiguration) GetChildsUuid() []string{
	var childs []string
	return childs
}
