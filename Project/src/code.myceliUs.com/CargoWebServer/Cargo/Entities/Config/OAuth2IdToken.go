...
func (this *OAuth2IdToken) SetNeedSave(needSave bool){
...
func (this *OAuth2IdToken) GetFieldValue(field string) interface{}{
...
func (this *OAuth2IdToken) GetChildsUuid() []string{
	var childs []string
	return childs
}
