...
func (this *OAuth2Client) SetNeedSave(needSave bool){
	this.needSave=needSave
}

func (this *OAuth2Client) GetReferenced() []string {
...
func (this *OAuth2Client) SetReferenced(uuid string, field string) {
	if this.Referenced == nil {
		this.Referenced = make([]string, 0)
	}
...
func (this *OAuth2Client) RemoveReferenced(uuid string, field string) {
	if this.Referenced == nil {
		return
	}
...
func (this *OAuth2Client) SetFieldValue(field string, value interface{}) error{
	return Utility.SetProperty(this, field, value)
}

func (this *OAuth2Client) GetFieldValue(field string) interface{}{
