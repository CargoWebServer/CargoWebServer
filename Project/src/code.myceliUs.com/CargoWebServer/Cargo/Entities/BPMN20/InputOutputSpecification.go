...
func (this *InputOutputSpecification) RemoveExtensionElements(ref interface{}){
	this.NeedSave = true
...
func (this *InputOutputSpecification) RemoveExtensionDefinitions(ref interface{}){
	this.NeedSave = true
...
func (this *InputOutputSpecification) RemoveExtensionValues(ref interface{}){
	this.NeedSave = true
