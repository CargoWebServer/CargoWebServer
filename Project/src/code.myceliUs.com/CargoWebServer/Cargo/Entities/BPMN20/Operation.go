...
func (this *Operation) RemoveExtensionElements(ref interface{}){
	this.NeedSave = true
...
func (this *Operation) RemoveExtensionDefinitions(ref interface{}){
	this.NeedSave = true
...
func (this *Operation) RemoveExtensionValues(ref interface{}){
	this.NeedSave = true
