...
func (this *DataInput) RemoveExtensionElements(ref interface{}){
	this.NeedSave = true
...
func (this *DataInput) RemoveExtensionDefinitions(ref interface{}){
	this.NeedSave = true
...
func (this *DataInput) RemoveExtensionValues(ref interface{}){
	this.NeedSave = true
