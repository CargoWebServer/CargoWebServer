...
func (this *Task_impl) RemoveExtensionElements(ref interface{}){
	this.NeedSave = true
...
func (this *Task_impl) RemoveExtensionDefinitions(ref interface{}){
	this.NeedSave = true
...
func (this *Task_impl) RemoveExtensionValues(ref interface{}){
	this.NeedSave = true
