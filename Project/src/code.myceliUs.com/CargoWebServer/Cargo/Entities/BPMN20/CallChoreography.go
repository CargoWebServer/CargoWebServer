...
func (this *CallChoreography) RemoveExtensionElements(ref interface{}){
	this.NeedSave = true
...
func (this *CallChoreography) RemoveExtensionDefinitions(ref interface{}){
	this.NeedSave = true
...
func (this *CallChoreography) RemoveExtensionValues(ref interface{}){
	this.NeedSave = true
