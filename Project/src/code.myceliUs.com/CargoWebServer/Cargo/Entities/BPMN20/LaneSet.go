...
func (this *LaneSet) RemoveExtensionElements(ref interface{}){
	this.NeedSave = true
...
func (this *LaneSet) RemoveExtensionDefinitions(ref interface{}){
	this.NeedSave = true
...
func (this *LaneSet) RemoveExtensionValues(ref interface{}){
	this.NeedSave = true
