...
func (this *BusinessRuleTask) RemoveExtensionElements(ref interface{}){
	this.NeedSave = true
...
func (this *BusinessRuleTask) RemoveExtensionDefinitions(ref interface{}){
	this.NeedSave = true
...
func (this *BusinessRuleTask) RemoveExtensionValues(ref interface{}){
	this.NeedSave = true
