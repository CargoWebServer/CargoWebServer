...
func (this *Choreography_impl) RemoveExtensionElements(ref interface{}){
	this.NeedSave = true
...
func (this *Choreography_impl) RemoveExtensionDefinitions(ref interface{}){
	this.NeedSave = true
...
func (this *Choreography_impl) RemoveExtensionValues(ref interface{}){
	this.NeedSave = true
