...
func (this *Property) RemoveExtensionElements(ref interface{}){
	this.NeedSave = true
...
func (this *Property) RemoveExtensionDefinitions(ref interface{}){
	this.NeedSave = true
...
func (this *Property) RemoveExtensionValues(ref interface{}){
	this.NeedSave = true
