...
func (this *DataObject) RemoveExtensionElements(ref interface{}){
	this.NeedSave = true
...
func (this *DataObject) RemoveExtensionDefinitions(ref interface{}){
	this.NeedSave = true
...
func (this *DataObject) RemoveExtensionValues(ref interface{}){
	this.NeedSave = true
