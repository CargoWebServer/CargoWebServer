...
func (this *Group) RemoveExtensionElements(ref interface{}){
	this.NeedSave = true
...
func (this *Group) RemoveExtensionDefinitions(ref interface{}){
	this.NeedSave = true
...
func (this *Group) RemoveExtensionValues(ref interface{}){
	this.NeedSave = true
