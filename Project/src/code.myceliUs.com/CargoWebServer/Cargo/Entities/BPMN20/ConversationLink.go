...
func (this *ConversationLink) RemoveExtensionElements(ref interface{}){
	this.NeedSave = true
...
func (this *ConversationLink) RemoveExtensionDefinitions(ref interface{}){
	this.NeedSave = true
...
func (this *ConversationLink) RemoveExtensionValues(ref interface{}){
	this.NeedSave = true
