...
func (this *Resource) RemoveExtensionElements(ref interface{}){
	this.NeedSave = true
...
func (this *Resource) RemoveExtensionDefinitions(ref interface{}){
	this.NeedSave = true
...
func (this *Resource) RemoveExtensionValues(ref interface{}){
	this.NeedSave = true
