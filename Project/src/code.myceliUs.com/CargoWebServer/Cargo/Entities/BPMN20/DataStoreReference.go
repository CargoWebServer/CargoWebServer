...
func (this *DataStoreReference) RemoveExtensionElements(ref interface{}){
	this.NeedSave = true
...
func (this *DataStoreReference) RemoveExtensionDefinitions(ref interface{}){
	this.NeedSave = true
...
func (this *DataStoreReference) RemoveExtensionValues(ref interface{}){
	this.NeedSave = true
