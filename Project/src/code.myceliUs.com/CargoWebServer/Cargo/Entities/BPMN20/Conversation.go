...
func (this *Conversation) RemoveExtensionElements(ref interface{}){
	this.NeedSave = true
...
func (this *Conversation) RemoveExtensionDefinitions(ref interface{}){
	this.NeedSave = true
...
func (this *Conversation) RemoveExtensionValues(ref interface{}){
	this.NeedSave = true
