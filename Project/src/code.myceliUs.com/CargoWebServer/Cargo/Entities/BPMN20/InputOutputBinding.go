...
func (this *InputOutputBinding) RemoveExtensionElements(ref interface{}){
	this.NeedSave = true
...
func (this *InputOutputBinding) RemoveExtensionDefinitions(ref interface{}){
	this.NeedSave = true
...
func (this *InputOutputBinding) RemoveExtensionValues(ref interface{}){
	this.NeedSave = true
