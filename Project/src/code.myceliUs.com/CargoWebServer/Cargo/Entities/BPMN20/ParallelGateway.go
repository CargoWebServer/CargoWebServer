...
func (this *ParallelGateway) RemoveExtensionElements(ref interface{}){
	this.NeedSave = true
...
func (this *ParallelGateway) RemoveExtensionDefinitions(ref interface{}){
	this.NeedSave = true
...
func (this *ParallelGateway) RemoveExtensionValues(ref interface{}){
	this.NeedSave = true
