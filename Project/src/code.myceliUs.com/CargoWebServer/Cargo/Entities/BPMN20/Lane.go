...
func (this *Lane) RemoveExtensionElements(ref interface{}){
	this.NeedSave = true
...
func (this *Lane) RemoveExtensionDefinitions(ref interface{}){
	this.NeedSave = true
...
func (this *Lane) RemoveExtensionValues(ref interface{}){
	this.NeedSave = true
