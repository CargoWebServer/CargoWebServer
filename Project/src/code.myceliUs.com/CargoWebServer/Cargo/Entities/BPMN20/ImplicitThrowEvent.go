...
func (this *ImplicitThrowEvent) RemoveExtensionElements(ref interface{}){
	this.NeedSave = true
...
func (this *ImplicitThrowEvent) RemoveExtensionDefinitions(ref interface{}){
	this.NeedSave = true
...
func (this *ImplicitThrowEvent) RemoveExtensionValues(ref interface{}){
	this.NeedSave = true
