...
func (this *EventBasedGateway) RemoveExtensionElements(ref interface{}){
	this.NeedSave = true
...
func (this *EventBasedGateway) RemoveExtensionDefinitions(ref interface{}){
	this.NeedSave = true
...
func (this *EventBasedGateway) RemoveExtensionValues(ref interface{}){
	this.NeedSave = true
