...
func (this *MessageFlowAssociation) RemoveExtensionElements(ref interface{}){
	this.NeedSave = true
...
func (this *MessageFlowAssociation) RemoveExtensionDefinitions(ref interface{}){
	this.NeedSave = true
...
func (this *MessageFlowAssociation) RemoveExtensionValues(ref interface{}){
	this.NeedSave = true
