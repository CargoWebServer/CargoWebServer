...
func (this *EndPoint) RemoveExtensionElements(ref interface{}){
	this.NeedSave = true
...
func (this *EndPoint) RemoveExtensionDefinitions(ref interface{}){
	this.NeedSave = true
...
func (this *EndPoint) RemoveExtensionValues(ref interface{}){
	this.NeedSave = true
