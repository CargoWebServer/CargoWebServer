...
func (this *Collaboration_impl) RemoveExtensionElements(ref interface{}){
	this.NeedSave = true
...
func (this *Collaboration_impl) RemoveExtensionDefinitions(ref interface{}){
	this.NeedSave = true
...
func (this *Collaboration_impl) RemoveExtensionValues(ref interface{}){
	this.NeedSave = true
