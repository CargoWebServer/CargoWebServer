...
func (this *DataStore) RemoveExtensionElements(ref interface{}){
	this.NeedSave = true
...
func (this *DataStore) RemoveExtensionDefinitions(ref interface{}){
	this.NeedSave = true
...
func (this *DataStore) RemoveExtensionValues(ref interface{}){
	this.NeedSave = true
