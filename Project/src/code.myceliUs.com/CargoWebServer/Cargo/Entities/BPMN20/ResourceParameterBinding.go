...
func (this *ResourceParameterBinding) RemoveExtensionElements(ref interface{}){
	this.NeedSave = true
...
func (this *ResourceParameterBinding) RemoveExtensionDefinitions(ref interface{}){
	this.NeedSave = true
...
func (this *ResourceParameterBinding) RemoveExtensionValues(ref interface{}){
	this.NeedSave = true
