...
func (this *Message) RemoveExtensionElements(ref interface{}){
	this.NeedSave = true
...
func (this *Message) RemoveExtensionDefinitions(ref interface{}){
	this.NeedSave = true
...
func (this *Message) RemoveExtensionValues(ref interface{}){
	this.NeedSave = true
