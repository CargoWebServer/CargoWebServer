...
func (this *ConditionalEventDefinition) RemoveExtensionElements(ref interface{}){
	this.NeedSave = true
...
func (this *ConditionalEventDefinition) RemoveExtensionDefinitions(ref interface{}){
	this.NeedSave = true
...
func (this *ConditionalEventDefinition) RemoveExtensionValues(ref interface{}){
	this.NeedSave = true
