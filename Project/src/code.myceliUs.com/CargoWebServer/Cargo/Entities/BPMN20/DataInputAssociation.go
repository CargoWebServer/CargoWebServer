...
func (this *DataInputAssociation) RemoveExtensionElements(ref interface{}){
	this.NeedSave = true
...
func (this *DataInputAssociation) RemoveExtensionDefinitions(ref interface{}){
	this.NeedSave = true
...
func (this *DataInputAssociation) RemoveExtensionValues(ref interface{}){
	this.NeedSave = true
