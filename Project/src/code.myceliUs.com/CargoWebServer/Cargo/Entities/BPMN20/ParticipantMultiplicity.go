...
func (this *ParticipantMultiplicity) RemoveExtensionElements(ref interface{}){
	this.NeedSave = true
...
func (this *ParticipantMultiplicity) RemoveExtensionDefinitions(ref interface{}){
	this.NeedSave = true
...
func (this *ParticipantMultiplicity) RemoveExtensionValues(ref interface{}){
	this.NeedSave = true
