...
func (this *PartnerEntity) RemoveExtensionElements(ref interface{}){
	this.NeedSave = true
...
func (this *PartnerEntity) RemoveExtensionDefinitions(ref interface{}){
	this.NeedSave = true
...
func (this *PartnerEntity) RemoveExtensionValues(ref interface{}){
	this.NeedSave = true
