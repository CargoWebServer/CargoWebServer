...
func (this *GlobalTask_impl) RemoveExtensionElements(ref interface{}){
	this.NeedSave = true
...
func (this *GlobalTask_impl) RemoveExtensionDefinitions(ref interface{}){
	this.NeedSave = true
...
func (this *GlobalTask_impl) RemoveExtensionValues(ref interface{}){
	this.NeedSave = true
