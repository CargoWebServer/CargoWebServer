...
func (this *SubConversation) RemoveExtensionElements(ref interface{}){
	this.NeedSave = true
...
func (this *SubConversation) RemoveExtensionDefinitions(ref interface{}){
	this.NeedSave = true
...
func (this *SubConversation) RemoveExtensionValues(ref interface{}){
	this.NeedSave = true
