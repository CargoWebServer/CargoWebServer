...
func (this *CallableElement_impl) RemoveExtensionElements(ref interface{}){
	this.NeedSave = true
...
func (this *CallableElement_impl) RemoveExtensionDefinitions(ref interface{}){
	this.NeedSave = true
...
func (this *CallableElement_impl) RemoveExtensionValues(ref interface{}){
	this.NeedSave = true
