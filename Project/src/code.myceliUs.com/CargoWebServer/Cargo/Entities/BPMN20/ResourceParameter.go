...
func (this *ResourceParameter) RemoveExtensionElements(ref interface{}){
	this.NeedSave = true
...
func (this *ResourceParameter) RemoveExtensionDefinitions(ref interface{}){
	this.NeedSave = true
...
func (this *ResourceParameter) RemoveExtensionValues(ref interface{}){
	this.NeedSave = true
