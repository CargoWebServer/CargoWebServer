...
func (this *Participant) RemoveExtensionElements(ref interface{}){
	this.NeedSave = true
...
func (this *Participant) RemoveExtensionDefinitions(ref interface{}){
	this.NeedSave = true
...
func (this *Participant) RemoveExtensionValues(ref interface{}){
	this.NeedSave = true
