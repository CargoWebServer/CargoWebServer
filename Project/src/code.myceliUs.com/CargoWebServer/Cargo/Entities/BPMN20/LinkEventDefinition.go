...
func (this *LinkEventDefinition) RemoveExtensionElements(ref interface{}){
	this.NeedSave = true
...
func (this *LinkEventDefinition) RemoveExtensionDefinitions(ref interface{}){
	this.NeedSave = true
...
func (this *LinkEventDefinition) RemoveExtensionValues(ref interface{}){
	this.NeedSave = true
