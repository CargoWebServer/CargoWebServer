...
func (this *TextAnnotation) RemoveExtensionElements(ref interface{}){
	this.NeedSave = true
...
func (this *TextAnnotation) RemoveExtensionDefinitions(ref interface{}){
	this.NeedSave = true
...
func (this *TextAnnotation) RemoveExtensionValues(ref interface{}){
	this.NeedSave = true
...
func (this *TextAnnotation) RemoveText(ref interface{}){
	this.NeedSave = true
	toDelete := ref.(*Text)
	if toDelete.GetUUID() == this.M_text.GetUUID() {
		this.M_text = nil
	}
}
