...
func (this *CallConversation) RemoveExtensionElements(ref interface{}){
	this.NeedSave = true
...
func (this *CallConversation) RemoveExtensionDefinitions(ref interface{}){
	this.NeedSave = true
...
func (this *CallConversation) RemoveExtensionValues(ref interface{}){
	this.NeedSave = true
