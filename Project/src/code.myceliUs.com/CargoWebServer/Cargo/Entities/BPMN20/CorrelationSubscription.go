...
func (this *CorrelationSubscription) RemoveExtensionElements(ref interface{}){
	this.NeedSave = true
...
func (this *CorrelationSubscription) RemoveExtensionDefinitions(ref interface{}){
	this.NeedSave = true
...
func (this *CorrelationSubscription) RemoveExtensionValues(ref interface{}){
	this.NeedSave = true
