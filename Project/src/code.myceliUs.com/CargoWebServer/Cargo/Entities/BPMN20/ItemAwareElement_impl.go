...
func (this *ItemAwareElement_impl) RemoveExtensionElements(ref interface{}){
	this.NeedSave = true
...
func (this *ItemAwareElement_impl) RemoveExtensionDefinitions(ref interface{}){
	this.NeedSave = true
...
func (this *ItemAwareElement_impl) RemoveExtensionValues(ref interface{}){
	this.NeedSave = true
