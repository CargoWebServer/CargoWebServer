...
func (this *ComplexGateway) RemoveExtensionElements(ref interface{}){
	this.NeedSave = true
...
func (this *ComplexGateway) RemoveExtensionDefinitions(ref interface{}){
	this.NeedSave = true
...
func (this *ComplexGateway) RemoveExtensionValues(ref interface{}){
	this.NeedSave = true
...
func (this *ComplexGateway) RemoveActivationCondition(ref interface{}){
	...
	if toDelete.GetUUID() == this.M_activationCondition.GetUUID() {
		this.M_activationCondition = nil
	}
}
