...
func (this *Rendering) RemoveExtensionElements(ref interface{}){
	this.NeedSave = true
...
func (this *Rendering) RemoveExtensionDefinitions(ref interface{}){
	this.NeedSave = true
...
func (this *Rendering) RemoveExtensionValues(ref interface{}){
	this.NeedSave = true
