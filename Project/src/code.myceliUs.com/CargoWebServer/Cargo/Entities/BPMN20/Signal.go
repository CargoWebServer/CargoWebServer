...
func (this *Signal) RemoveExtensionElements(ref interface{}){
	this.NeedSave = true
...
func (this *Signal) RemoveExtensionDefinitions(ref interface{}){
	this.NeedSave = true
...
func (this *Signal) RemoveExtensionValues(ref interface{}){
	this.NeedSave = true
