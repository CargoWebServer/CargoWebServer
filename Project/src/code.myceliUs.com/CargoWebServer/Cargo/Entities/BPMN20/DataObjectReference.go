...
func (this *DataObjectReference) RemoveExtensionElements(ref interface{}){
	this.NeedSave = true
...
func (this *DataObjectReference) RemoveExtensionDefinitions(ref interface{}){
	this.NeedSave = true
...
func (this *DataObjectReference) RemoveExtensionValues(ref interface{}){
	this.NeedSave = true
