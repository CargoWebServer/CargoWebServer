...
func (this *DataOutput) RemoveExtensionElements(ref interface{}){
	this.NeedSave = true
...
func (this *DataOutput) RemoveExtensionDefinitions(ref interface{}){
	this.NeedSave = true
...
func (this *DataOutput) RemoveExtensionValues(ref interface{}){
	this.NeedSave = true
