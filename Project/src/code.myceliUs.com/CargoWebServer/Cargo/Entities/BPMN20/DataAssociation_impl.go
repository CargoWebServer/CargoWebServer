...
type DataAssociation_impl struct{
...
/** Xml parser for DataAssociation **/
type XsdDataAssociation struct {
	XMLName xml.Name	`xml:"dataAssociation"`
	/** BaseElement **/
...
/** UUID **/
func (this *DataAssociation_impl) GetUUID() string{
	return this.UUID
}

/** Id **/
func (this *DataAssociation_impl) GetId() string{
	return this.M_id
}

/** Init reference Id **/
func (this *DataAssociation_impl) SetId(ref interface{}){
	this.NeedSave = true
...
/** Other **/
func (this *DataAssociation_impl) GetOther() interface{}{
	return this.M_other
}

/** Init reference Other **/
func (this *DataAssociation_impl) SetOther(ref interface{}){
	this.NeedSave = true
...
/** ExtensionElements **/
func (this *DataAssociation_impl) GetExtensionElements() *ExtensionElements{
	return this.M_extensionElements
}

/** Init reference ExtensionElements **/
func (this *DataAssociation_impl) SetExtensionElements(ref interface{}){
	this.NeedSave = true
	this.M_extensionElements = ref.(*ExtensionElements)
}

/** Remove reference ExtensionElements **/
func (this *DataAssociation_impl) RemoveExtensionElements(ref interface{}){
	this.NeedSave = true
...
func (this *DataAssociation_impl) GetExtensionDefinitions() []*ExtensionDefinition{
	return this.M_extensionDefinitions
}

/** Init reference ExtensionDefinitions **/
func (this *DataAssociation_impl) SetExtensionDefinitions(ref interface{}){
	this.NeedSave = true
	isExist := false
...
func (this *DataAssociation_impl) RemoveExtensionDefinitions(ref interface{}){
	this.NeedSave = true
...
/** ExtensionValues **/
func (this *DataAssociation_impl) GetExtensionValues() []*ExtensionAttributeValue{
	return this.M_extensionValues
}

/** Init reference ExtensionValues **/
func (this *DataAssociation_impl) SetExtensionValues(ref interface{}){
	this.NeedSave = true
	isExist := false
...
func (this *DataAssociation_impl) RemoveExtensionValues(ref interface{}){
	this.NeedSave = true
...
/** Documentation **/
func (this *DataAssociation_impl) GetDocumentation() []*Documentation{
	return this.M_documentation
}

/** Init reference Documentation **/
func (this *DataAssociation_impl) SetDocumentation(ref interface{}){
	this.NeedSave = true
	isExist := false
...
func (this *DataAssociation_impl) RemoveDocumentation(ref interface{}){
	this.NeedSave = true
...
/** Transformation **/
func (this *DataAssociation_impl) GetTransformation() *FormalExpression{
	return this.M_transformation
}

/** Init reference Transformation **/
func (this *DataAssociation_impl) SetTransformation(ref interface{}){
	this.NeedSave = true
	this.M_transformation = ref.(*FormalExpression)
}

/** Remove reference Transformation **/
func (this *DataAssociation_impl) RemoveTransformation(ref interface{}){
	this.NeedSave = true
	toDelete := ref.(BaseElement)
...
/** Assignment **/
func (this *DataAssociation_impl) GetAssignment() []*Assignment{
	return this.M_assignment
}

/** Init reference Assignment **/
func (this *DataAssociation_impl) SetAssignment(ref interface{}){
	this.NeedSave = true
	isExist := false
...
func (this *DataAssociation_impl) RemoveAssignment(ref interface{}){
	this.NeedSave = true
	toDelete := ref.(BaseElement)
...
/** TargetRef **/
func (this *DataAssociation_impl) GetTargetRef() ItemAwareElement{
	return this.m_targetRef
}

/** Init reference TargetRef **/
func (this *DataAssociation_impl) SetTargetRef(ref interface{}){
	this.NeedSave = true
	if _, ok := ref.(string); ok {
...
func (this *DataAssociation_impl) RemoveTargetRef(ref interface{}){
	this.NeedSave = true
	toDelete := ref.(BaseElement)
...
/** SourceRef **/
func (this *DataAssociation_impl) GetSourceRef() []ItemAwareElement{
	return this.m_sourceRef
}

/** Init reference SourceRef **/
func (this *DataAssociation_impl) SetSourceRef(ref interface{}){
	this.NeedSave = true
...
func (this *DataAssociation_impl) RemoveSourceRef(ref interface{}){
	this.NeedSave = true
	toDelete := ref.(BaseElement)
...
/** Lane **/
func (this *DataAssociation_impl) GetLanePtr() []*Lane{
	return this.m_lanePtr
}

/** Init reference Lane **/
func (this *DataAssociation_impl) SetLanePtr(ref interface{}){
	this.NeedSave = true
	if refStr, ok := ref.(string); ok {
...
func (this *DataAssociation_impl) RemoveLanePtr(ref interface{}){
	this.NeedSave = true
	toDelete := ref.(BaseElement)
...
/** Outgoing **/
func (this *DataAssociation_impl) GetOutgoingPtr() []*Association{
	return this.m_outgoingPtr
}

/** Init reference Outgoing **/
func (this *DataAssociation_impl) SetOutgoingPtr(ref interface{}){
	this.NeedSave = true
	if refStr, ok := ref.(string); ok {
...
func (this *DataAssociation_impl) RemoveOutgoingPtr(ref interface{}){
	this.NeedSave = true
	toDelete := ref.(BaseElement)
...
/** Incoming **/
func (this *DataAssociation_impl) GetIncomingPtr() []*Association{
	return this.m_incomingPtr
}

/** Init reference Incoming **/
func (this *DataAssociation_impl) SetIncomingPtr(ref interface{}){
	this.NeedSave = true
	if refStr, ok := ref.(string); ok {
...
func (this *DataAssociation_impl) RemoveIncomingPtr(ref interface{}){
	this.NeedSave = true
	toDelete := ref.(BaseElement)
