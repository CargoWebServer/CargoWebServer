...
func (this *CompensateEventDefinition) RemoveExtensionElements(ref interface{}){
	this.NeedSave = true
...
func (this *CompensateEventDefinition) RemoveExtensionDefinitions(ref interface{}){
	this.NeedSave = true
...
func (this *CompensateEventDefinition) RemoveExtensionValues(ref interface{}){
	this.NeedSave = true
