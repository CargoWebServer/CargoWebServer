...
func (this *ReceiveTask) RemoveExtensionElements(ref interface{}){
	this.NeedSave = true
...
func (this *ReceiveTask) RemoveExtensionDefinitions(ref interface{}){
	this.NeedSave = true
...
func (this *ReceiveTask) RemoveExtensionValues(ref interface{}){
	this.NeedSave = true
