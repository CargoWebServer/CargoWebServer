...
func (this *GlobalManualTask) RemoveExtensionElements(ref interface{}){
	this.NeedSave = true
...
func (this *GlobalManualTask) RemoveExtensionDefinitions(ref interface{}){
	this.NeedSave = true
...
func (this *GlobalManualTask) RemoveExtensionValues(ref interface{}){
	this.NeedSave = true
