...
func (this *ExclusiveGateway) RemoveExtensionElements(ref interface{}){
	this.NeedSave = true
...
func (this *ExclusiveGateway) RemoveExtensionDefinitions(ref interface{}){
	this.NeedSave = true
...
func (this *ExclusiveGateway) RemoveExtensionValues(ref interface{}){
	this.NeedSave = true
