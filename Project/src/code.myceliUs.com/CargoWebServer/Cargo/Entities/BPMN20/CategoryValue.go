...
func (this *CategoryValue) RemoveExtensionElements(ref interface{}){
	this.NeedSave = true
...
func (this *CategoryValue) RemoveExtensionDefinitions(ref interface{}){
	this.NeedSave = true
...
func (this *CategoryValue) RemoveExtensionValues(ref interface{}){
	this.NeedSave = true
