...
func (this *SignalEventDefinition) RemoveExtensionElements(ref interface{}){
	this.NeedSave = true
...
func (this *SignalEventDefinition) RemoveExtensionDefinitions(ref interface{}){
	this.NeedSave = true
...
func (this *SignalEventDefinition) RemoveExtensionValues(ref interface{}){
	this.NeedSave = true
