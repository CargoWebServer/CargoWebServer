...
func (this *Script) RemoveExtensionElements(ref interface{}){
	this.NeedSave = true
...
func (this *Script) RemoveExtensionDefinitions(ref interface{}){
	this.NeedSave = true
...
func (this *Script) RemoveExtensionValues(ref interface{}){
	this.NeedSave = true
