...
func (this *GlobalConversation) RemoveExtensionElements(ref interface{}){
	this.NeedSave = true
...
func (this *GlobalConversation) RemoveExtensionDefinitions(ref interface{}){
	this.NeedSave = true
...
func (this *GlobalConversation) RemoveExtensionValues(ref interface{}){
	this.NeedSave = true
