...
func (this *OutputSet) RemoveExtensionElements(ref interface{}){
	this.NeedSave = true
...
func (this *OutputSet) RemoveExtensionDefinitions(ref interface{}){
	this.NeedSave = true
...
func (this *OutputSet) RemoveExtensionValues(ref interface{}){
	this.NeedSave = true
