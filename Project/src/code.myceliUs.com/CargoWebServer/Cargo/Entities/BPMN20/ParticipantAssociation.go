...
func (this *ParticipantAssociation) RemoveExtensionElements(ref interface{}){
	this.NeedSave = true
...
func (this *ParticipantAssociation) RemoveExtensionDefinitions(ref interface{}){
	this.NeedSave = true
...
func (this *ParticipantAssociation) RemoveExtensionValues(ref interface{}){
	this.NeedSave = true
