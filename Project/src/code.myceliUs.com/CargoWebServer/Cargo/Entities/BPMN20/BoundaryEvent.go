...
func (this *BoundaryEvent) RemoveExtensionElements(ref interface{}){
	this.NeedSave = true
...
func (this *BoundaryEvent) RemoveExtensionDefinitions(ref interface{}){
	this.NeedSave = true
...
func (this *BoundaryEvent) RemoveExtensionValues(ref interface{}){
	this.NeedSave = true
