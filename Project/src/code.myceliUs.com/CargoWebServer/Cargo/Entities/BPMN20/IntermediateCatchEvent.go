...
func (this *IntermediateCatchEvent) RemoveExtensionElements(ref interface{}){
	this.NeedSave = true
...
func (this *IntermediateCatchEvent) RemoveExtensionDefinitions(ref interface{}){
	this.NeedSave = true
...
func (this *IntermediateCatchEvent) RemoveExtensionValues(ref interface{}){
	this.NeedSave = true
