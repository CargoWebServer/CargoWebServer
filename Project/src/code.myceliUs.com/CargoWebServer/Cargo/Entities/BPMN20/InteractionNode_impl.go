...
func (this *InteractionNode_impl) RemoveExtensionElements(ref interface{}){
	this.NeedSave = true
...
func (this *InteractionNode_impl) RemoveExtensionDefinitions(ref interface{}){
	this.NeedSave = true
...
func (this *InteractionNode_impl) RemoveExtensionValues(ref interface{}){
	this.NeedSave = true
