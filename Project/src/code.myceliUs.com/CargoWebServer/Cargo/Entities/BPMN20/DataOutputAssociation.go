...
func (this *DataOutputAssociation) RemoveExtensionElements(ref interface{}){
	this.NeedSave = true
...
func (this *DataOutputAssociation) RemoveExtensionDefinitions(ref interface{}){
	this.NeedSave = true
...
func (this *DataOutputAssociation) RemoveExtensionValues(ref interface{}){
	this.NeedSave = true
