...
func (this *Performer_impl) RemoveExtensionElements(ref interface{}){
	this.NeedSave = true
...
func (this *Performer_impl) RemoveExtensionDefinitions(ref interface{}){
	this.NeedSave = true
...
func (this *Performer_impl) RemoveExtensionValues(ref interface{}){
	this.NeedSave = true
