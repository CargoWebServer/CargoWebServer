...
func (this *Auditing) RemoveExtensionElements(ref interface{}){
	this.NeedSave = true
...
func (this *Auditing) RemoveExtensionDefinitions(ref interface{}){
	this.NeedSave = true
...
func (this *Auditing) RemoveExtensionValues(ref interface{}){
	this.NeedSave = true
