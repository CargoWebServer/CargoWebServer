...
func (this *ManualTask) RemoveExtensionElements(ref interface{}){
	this.NeedSave = true
...
func (this *ManualTask) RemoveExtensionDefinitions(ref interface{}){
	this.NeedSave = true
...
func (this *ManualTask) RemoveExtensionValues(ref interface{}){
	this.NeedSave = true
