...
func (this *Process) RemoveExtensionElements(ref interface{}){
	this.NeedSave = true
...
func (this *Process) RemoveExtensionDefinitions(ref interface{}){
	this.NeedSave = true
...
func (this *Process) RemoveExtensionValues(ref interface{}){
	this.NeedSave = true
