...
/** Xml parser for SubProcess **/
type XsdSubProcess struct {
...
/** UUID **/
func (this *SubProcess_impl) GetUUID() string{
	return this.UUID
}

/** Id **/
func (this *SubProcess_impl) GetId() string{
	return this.M_id
}

/** Init reference Id **/
func (this *SubProcess_impl) SetId(ref interface{}){
	this.NeedSave = true
...
/** Other **/
func (this *SubProcess_impl) GetOther() interface{}{
	return this.M_other
}

/** Init reference Other **/
func (this *SubProcess_impl) SetOther(ref interface{}){
	this.NeedSave = true
...
/** ExtensionElements **/
func (this *SubProcess_impl) GetExtensionElements() *ExtensionElements{
	return this.M_extensionElements
}

/** Init reference ExtensionElements **/
func (this *SubProcess_impl) SetExtensionElements(ref interface{}){
	this.NeedSave = true
	this.M_extensionElements = ref.(*ExtensionElements)
}

/** Remove reference ExtensionElements **/
func (this *SubProcess_impl) RemoveExtensionElements(ref interface{}){
	this.NeedSave = true
...
func (this *SubProcess_impl) GetExtensionDefinitions() []*ExtensionDefinition{
	return this.M_extensionDefinitions
}

/** Init reference ExtensionDefinitions **/
func (this *SubProcess_impl) SetExtensionDefinitions(ref interface{}){
	this.NeedSave = true
	isExist := false
...
func (this *SubProcess_impl) RemoveExtensionDefinitions(ref interface{}){
	this.NeedSave = true
...
/** ExtensionValues **/
func (this *SubProcess_impl) GetExtensionValues() []*ExtensionAttributeValue{
	return this.M_extensionValues
}

/** Init reference ExtensionValues **/
func (this *SubProcess_impl) SetExtensionValues(ref interface{}){
	this.NeedSave = true
	isExist := false
...
func (this *SubProcess_impl) RemoveExtensionValues(ref interface{}){
	this.NeedSave = true
...
/** Documentation **/
func (this *SubProcess_impl) GetDocumentation() []*Documentation{
	return this.M_documentation
}

/** Init reference Documentation **/
func (this *SubProcess_impl) SetDocumentation(ref interface{}){
	this.NeedSave = true
	isExist := false
...
func (this *SubProcess_impl) RemoveDocumentation(ref interface{}){
	this.NeedSave = true
...
/** Name **/
func (this *SubProcess_impl) GetName() string{
	return this.M_name
}

/** Init reference Name **/
func (this *SubProcess_impl) SetName(ref interface{}){
	this.NeedSave = true
...
/** Auditing **/
func (this *SubProcess_impl) GetAuditing() *Auditing{
	return this.M_auditing
}

/** Init reference Auditing **/
func (this *SubProcess_impl) SetAuditing(ref interface{}){
	this.NeedSave = true
	this.M_auditing = ref.(*Auditing)
}

/** Remove reference Auditing **/
func (this *SubProcess_impl) RemoveAuditing(ref interface{}){
	this.NeedSave = true
	toDelete := ref.(BaseElement)
...
/** Monitoring **/
func (this *SubProcess_impl) GetMonitoring() *Monitoring{
	return this.M_monitoring
}

/** Init reference Monitoring **/
func (this *SubProcess_impl) SetMonitoring(ref interface{}){
	this.NeedSave = true
	this.M_monitoring = ref.(*Monitoring)
}

/** Remove reference Monitoring **/
func (this *SubProcess_impl) RemoveMonitoring(ref interface{}){
	this.NeedSave = true
	toDelete := ref.(BaseElement)
...
/** CategoryValueRef **/
func (this *SubProcess_impl) GetCategoryValueRef() []*CategoryValue{
	return this.m_categoryValueRef
}

/** Init reference CategoryValueRef **/
func (this *SubProcess_impl) SetCategoryValueRef(ref interface{}){
	this.NeedSave = true
...
func (this *SubProcess_impl) RemoveCategoryValueRef(ref interface{}){
	this.NeedSave = true
	toDelete := ref.(BaseElement)
...
/** Outgoing **/
func (this *SubProcess_impl) GetOutgoing() []*SequenceFlow{
	return this.m_outgoing
}

/** Init reference Outgoing **/
func (this *SubProcess_impl) SetOutgoing(ref interface{}){
	this.NeedSave = true
	if refStr, ok := ref.(string); ok {
...
func (this *SubProcess_impl) RemoveOutgoing(ref interface{}){
	this.NeedSave = true
	toDelete := ref.(BaseElement)
...
/** Incoming **/
func (this *SubProcess_impl) GetIncoming() []*SequenceFlow{
	return this.m_incoming
}

/** Init reference Incoming **/
func (this *SubProcess_impl) SetIncoming(ref interface{}){
	this.NeedSave = true
	if refStr, ok := ref.(string); ok {
...
func (this *SubProcess_impl) RemoveIncoming(ref interface{}){
	this.NeedSave = true
	toDelete := ref.(BaseElement)
...
/** Lanes **/
func (this *SubProcess_impl) GetLanes() []*Lane{
	return this.m_lanes
}

/** Init reference Lanes **/
func (this *SubProcess_impl) SetLanes(ref interface{}){
	this.NeedSave = true
	if refStr, ok := ref.(string); ok {
...
func (this *SubProcess_impl) RemoveLanes(ref interface{}){
	this.NeedSave = true
	toDelete := ref.(BaseElement)
	lanes_ := make([]*Lane, 0)
...
/** IsForCompensation **/
func (this *SubProcess_impl) IsForCompensation() bool{
	return this.M_isForCompensation
}

/** Init reference IsForCompensation **/
func (this *SubProcess_impl) SetIsForCompensation(ref interface{}){
	this.NeedSave = true
...
/** LoopCharacteristics **/
func (this *SubProcess_impl) GetLoopCharacteristics() LoopCharacteristics{
	return this.M_loopCharacteristics
}

/** Init reference LoopCharacteristics **/
func (this *SubProcess_impl) SetLoopCharacteristics(ref interface{}){
	this.NeedSave = true
	this.M_loopCharacteristics = ref.(LoopCharacteristics)
}

/** Remove reference LoopCharacteristics **/
func (this *SubProcess_impl) RemoveLoopCharacteristics(ref interface{}){
	this.NeedSave = true
	toDelete := ref.(BaseElement)
...
/** ResourceRole **/
func (this *SubProcess_impl) GetResourceRole() []ResourceRole{
	return this.M_resourceRole
}

/** Init reference ResourceRole **/
func (this *SubProcess_impl) SetResourceRole(ref interface{}){
	this.NeedSave = true
	isExist := false
...
func (this *SubProcess_impl) RemoveResourceRole(ref interface{}){
	this.NeedSave = true
	toDelete := ref.(BaseElement)
...
/** Default **/
func (this *SubProcess_impl) GetDefault() *SequenceFlow{
	return this.m_default
}

/** Init reference Default **/
func (this *SubProcess_impl) SetDefault(ref interface{}){
	this.NeedSave = true
	if _, ok := ref.(string); ok {
...
func (this *SubProcess_impl) RemoveDefault(ref interface{}){
	this.NeedSave = true
	toDelete := ref.(BaseElement)
...
/** Property **/
func (this *SubProcess_impl) GetProperty() []*Property{
	return this.M_property
}

/** Init reference Property **/
func (this *SubProcess_impl) SetProperty(ref interface{}){
	this.NeedSave = true
	isExist := false
...
func (this *SubProcess_impl) RemoveProperty(ref interface{}){
	this.NeedSave = true
	toDelete := ref.(BaseElement)
...
/** IoSpecification **/
func (this *SubProcess_impl) GetIoSpecification() *InputOutputSpecification{
	return this.M_ioSpecification
}

/** Init reference IoSpecification **/
func (this *SubProcess_impl) SetIoSpecification(ref interface{}){
	this.NeedSave = true
	this.M_ioSpecification = ref.(*InputOutputSpecification)
}

/** Remove reference IoSpecification **/
func (this *SubProcess_impl) RemoveIoSpecification(ref interface{}){
	this.NeedSave = true
	toDelete := ref.(BaseElement)
...
/** BoundaryEventRefs **/
func (this *SubProcess_impl) GetBoundaryEventRefs() []*BoundaryEvent{
	return this.m_boundaryEventRefs
}

/** Init reference BoundaryEventRefs **/
func (this *SubProcess_impl) SetBoundaryEventRefs(ref interface{}){
	this.NeedSave = true
	if refStr, ok := ref.(string); ok {
...
func (this *SubProcess_impl) RemoveBoundaryEventRefs(ref interface{}){
	this.NeedSave = true
	toDelete := ref.(BaseElement)
...
func (this *SubProcess_impl) GetDataInputAssociation() []*DataInputAssociation{
	return this.M_dataInputAssociation
}

/** Init reference DataInputAssociation **/
func (this *SubProcess_impl) SetDataInputAssociation(ref interface{}){
	this.NeedSave = true
	isExist := false
...
func (this *SubProcess_impl) RemoveDataInputAssociation(ref interface{}){
	this.NeedSave = true
	toDelete := ref.(BaseElement)
...
func (this *SubProcess_impl) GetDataOutputAssociation() []*DataOutputAssociation{
	return this.M_dataOutputAssociation
}

/** Init reference DataOutputAssociation **/
func (this *SubProcess_impl) SetDataOutputAssociation(ref interface{}){
	this.NeedSave = true
	isExist := false
...
func (this *SubProcess_impl) RemoveDataOutputAssociation(ref interface{}){
	this.NeedSave = true
	toDelete := ref.(BaseElement)
...
/** StartQuantity **/
func (this *SubProcess_impl) GetStartQuantity() int{
	return this.M_startQuantity
}

/** Init reference StartQuantity **/
func (this *SubProcess_impl) SetStartQuantity(ref interface{}){
	this.NeedSave = true
...
/** CompletionQuantity **/
func (this *SubProcess_impl) GetCompletionQuantity() int{
	return this.M_completionQuantity
}

/** Init reference CompletionQuantity **/
func (this *SubProcess_impl) SetCompletionQuantity(ref interface{}){
	this.NeedSave = true
...
/** FlowElement **/
func (this *SubProcess_impl) GetFlowElement() []FlowElement{
	return this.M_flowElement
}

/** Init reference FlowElement **/
func (this *SubProcess_impl) SetFlowElement(ref interface{}){
	this.NeedSave = true
	isExist := false
...
func (this *SubProcess_impl) RemoveFlowElement(ref interface{}){
	this.NeedSave = true
	toDelete := ref.(BaseElement)
...
/** LaneSet **/
func (this *SubProcess_impl) GetLaneSet() []*LaneSet{
	return this.M_laneSet
}

/** Init reference LaneSet **/
func (this *SubProcess_impl) SetLaneSet(ref interface{}){
	this.NeedSave = true
	isExist := false
...
func (this *SubProcess_impl) RemoveLaneSet(ref interface{}){
	this.NeedSave = true
	toDelete := ref.(BaseElement)
...
/** TriggeredByEvent **/
func (this *SubProcess_impl) GetTriggeredByEvent() bool{
	return this.M_triggeredByEvent
}

/** Init reference TriggeredByEvent **/
func (this *SubProcess_impl) SetTriggeredByEvent(ref interface{}){
	this.NeedSave = true
...
/** Artifact **/
func (this *SubProcess_impl) GetArtifact() []Artifact{
	return this.M_artifact
}

/** Init reference Artifact **/
func (this *SubProcess_impl) SetArtifact(ref interface{}){
	this.NeedSave = true
	isExist := false
...
func (this *SubProcess_impl) RemoveArtifact(ref interface{}){
	this.NeedSave = true
	toDelete := ref.(BaseElement)
...
/** Lane **/
func (this *SubProcess_impl) GetLanePtr() []*Lane{
	return this.m_lanePtr
}

/** Init reference Lane **/
func (this *SubProcess_impl) SetLanePtr(ref interface{}){
	this.NeedSave = true
	if refStr, ok := ref.(string); ok {
...
func (this *SubProcess_impl) RemoveLanePtr(ref interface{}){
	this.NeedSave = true
	toDelete := ref.(BaseElement)
...
/** Outgoing **/
func (this *SubProcess_impl) GetOutgoingPtr() []*Association{
	return this.m_outgoingPtr
}

/** Init reference Outgoing **/
func (this *SubProcess_impl) SetOutgoingPtr(ref interface{}){
	this.NeedSave = true
	if refStr, ok := ref.(string); ok {
...
/** Remove reference Outgoing **/
func (this *SubProcess_impl) RemoveOutgoingPtr(ref interface{}){
	this.NeedSave = true
	toDelete := ref.(BaseElement)
...
/** Incoming **/
func (this *SubProcess_impl) GetIncomingPtr() []*Association{
	return this.m_incomingPtr
}

/** Init reference Incoming **/
func (this *SubProcess_impl) SetIncomingPtr(ref interface{}){
	this.NeedSave = true
	if refStr, ok := ref.(string); ok {
...
/** Remove reference Incoming **/
func (this *SubProcess_impl) RemoveIncomingPtr(ref interface{}){
	this.NeedSave = true
	toDelete := ref.(BaseElement)
...
/** Container **/
func (this *SubProcess_impl) GetContainerPtr() FlowElementsContainer{
	return this.m_containerPtr
}

/** Init reference Container **/
func (this *SubProcess_impl) SetContainerPtr(ref interface{}){
	this.NeedSave = true
	if _, ok := ref.(string); ok {
...
func (this *SubProcess_impl) RemoveContainerPtr(ref interface{}){
	this.NeedSave = true
	toDelete := ref.(BaseElement)
...
func (this *SubProcess_impl) GetCompensateEventDefinitionPtr() []*CompensateEventDefinition{
	return this.m_compensateEventDefinitionPtr
}

/** Init reference CompensateEventDefinition **/
func (this *SubProcess_impl) SetCompensateEventDefinitionPtr(ref interface{}){
	this.NeedSave = true
	if refStr, ok := ref.(string); ok {
...
func (this *SubProcess_impl) RemoveCompensateEventDefinitionPtr(ref interface{}){
	this.NeedSave = true
	toDelete := ref.(BaseElement)
