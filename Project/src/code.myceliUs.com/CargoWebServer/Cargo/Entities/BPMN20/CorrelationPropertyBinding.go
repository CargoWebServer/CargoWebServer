...
func (this *CorrelationPropertyBinding) RemoveExtensionElements(ref interface{}){
	this.NeedSave = true
...
func (this *CorrelationPropertyBinding) RemoveExtensionDefinitions(ref interface{}){
	this.NeedSave = true
...
func (this *CorrelationPropertyBinding) RemoveExtensionValues(ref interface{}){
	this.NeedSave = true
...
func (this *CorrelationPropertyBinding) RemoveCorrelationPropertyRef(ref interface{}){
	...
	if toDelete.GetUUID() == this.m_correlationPropertyRef.GetUUID() {
		this.m_correlationPropertyRef = nil
		this.M_correlationPropertyRef = ""
	}
}
...
func (this *CorrelationPropertyBinding) RemoveCorrelationSubscriptionPtr(ref interface{}){
	...
	if toDelete.GetUUID() == this.m_correlationSubscriptionPtr.GetUUID() {
		this.m_correlationSubscriptionPtr = nil
		this.M_correlationSubscriptionPtr = ""
	}
}
