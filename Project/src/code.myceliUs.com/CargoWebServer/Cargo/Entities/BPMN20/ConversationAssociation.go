...
func (this *ConversationAssociation) RemoveExtensionElements(ref interface{}){
	this.NeedSave = true
...
func (this *ConversationAssociation) RemoveExtensionDefinitions(ref interface{}){
	this.NeedSave = true
...
func (this *ConversationAssociation) RemoveExtensionValues(ref interface{}){
	this.NeedSave = true
