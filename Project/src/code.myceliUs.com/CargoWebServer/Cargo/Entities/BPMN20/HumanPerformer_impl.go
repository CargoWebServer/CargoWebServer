...
type HumanPerformer_impl struct{
...
/** Xml parser for HumanPerformer **/
type XsdHumanPerformer struct {
	XMLName xml.Name	`xml:"humanPerformer"`
	/** BaseElement **/
...
/** UUID **/
func (this *HumanPerformer_impl) GetUUID() string{
	return this.UUID
}

/** Id **/
func (this *HumanPerformer_impl) GetId() string{
	return this.M_id
}

/** Init reference Id **/
func (this *HumanPerformer_impl) SetId(ref interface{}){
	this.NeedSave = true
...
/** Other **/
func (this *HumanPerformer_impl) GetOther() interface{}{
	return this.M_other
}

/** Init reference Other **/
func (this *HumanPerformer_impl) SetOther(ref interface{}){
	this.NeedSave = true
...
/** ExtensionElements **/
func (this *HumanPerformer_impl) GetExtensionElements() *ExtensionElements{
	return this.M_extensionElements
}

/** Init reference ExtensionElements **/
func (this *HumanPerformer_impl) SetExtensionElements(ref interface{}){
	this.NeedSave = true
	this.M_extensionElements = ref.(*ExtensionElements)
}

/** Remove reference ExtensionElements **/
func (this *HumanPerformer_impl) RemoveExtensionElements(ref interface{}){
	this.NeedSave = true
...
func (this *HumanPerformer_impl) GetExtensionDefinitions() []*ExtensionDefinition{
	return this.M_extensionDefinitions
}

/** Init reference ExtensionDefinitions **/
func (this *HumanPerformer_impl) SetExtensionDefinitions(ref interface{}){
	this.NeedSave = true
	isExist := false
...
func (this *HumanPerformer_impl) RemoveExtensionDefinitions(ref interface{}){
	this.NeedSave = true
...
/** ExtensionValues **/
func (this *HumanPerformer_impl) GetExtensionValues() []*ExtensionAttributeValue{
	return this.M_extensionValues
}

/** Init reference ExtensionValues **/
func (this *HumanPerformer_impl) SetExtensionValues(ref interface{}){
	this.NeedSave = true
	isExist := false
...
func (this *HumanPerformer_impl) RemoveExtensionValues(ref interface{}){
	this.NeedSave = true
...
/** Documentation **/
func (this *HumanPerformer_impl) GetDocumentation() []*Documentation{
	return this.M_documentation
}

/** Init reference Documentation **/
func (this *HumanPerformer_impl) SetDocumentation(ref interface{}){
	this.NeedSave = true
	isExist := false
...
func (this *HumanPerformer_impl) RemoveDocumentation(ref interface{}){
	this.NeedSave = true
...
/** ResourceRef **/
func (this *HumanPerformer_impl) GetResourceRef() *Resource{
	return this.m_resourceRef
}

/** Init reference ResourceRef **/
func (this *HumanPerformer_impl) SetResourceRef(ref interface{}){
	this.NeedSave = true
	if _, ok := ref.(string); ok {
...
func (this *HumanPerformer_impl) RemoveResourceRef(ref interface{}){
	this.NeedSave = true
	toDelete := ref.(BaseElement)
...
func (this *HumanPerformer_impl) GetResourceParameterBinding() []*ResourceParameterBinding{
	return this.M_resourceParameterBinding
}

/** Init reference ResourceParameterBinding **/
func (this *HumanPerformer_impl) SetResourceParameterBinding(ref interface{}){
	this.NeedSave = true
	isExist := false
...
func (this *HumanPerformer_impl) RemoveResourceParameterBinding(ref interface{}){
	this.NeedSave = true
	toDelete := ref.(BaseElement)
...
func (this *HumanPerformer_impl) GetResourceAssignmentExpression() *ResourceAssignmentExpression{
	return this.M_resourceAssignmentExpression
}

/** Init reference ResourceAssignmentExpression **/
func (this *HumanPerformer_impl) SetResourceAssignmentExpression(ref interface{}){
	this.NeedSave = true
	this.M_resourceAssignmentExpression = ref.(*ResourceAssignmentExpression)
}

/** Remove reference ResourceAssignmentExpression **/
func (this *HumanPerformer_impl) RemoveResourceAssignmentExpression(ref interface{}){
	this.NeedSave = true
	toDelete := ref.(BaseElement)
...
/** Name **/
func (this *HumanPerformer_impl) GetName() string{
	return this.M_name
}

/** Init reference Name **/
func (this *HumanPerformer_impl) SetName(ref interface{}){
	this.NeedSave = true
...
/** Lane **/
func (this *HumanPerformer_impl) GetLanePtr() []*Lane{
	return this.m_lanePtr
}

/** Init reference Lane **/
func (this *HumanPerformer_impl) SetLanePtr(ref interface{}){
	this.NeedSave = true
...
func (this *HumanPerformer_impl) RemoveLanePtr(ref interface{}){
	this.NeedSave = true
	toDelete := ref.(BaseElement)
...
/** Outgoing **/
func (this *HumanPerformer_impl) GetOutgoingPtr() []*Association{
	return this.m_outgoingPtr
}

/** Init reference Outgoing **/
func (this *HumanPerformer_impl) SetOutgoingPtr(ref interface{}){
	this.NeedSave = true
	if refStr, ok := ref.(string); ok {
...
func (this *HumanPerformer_impl) RemoveOutgoingPtr(ref interface{}){
	this.NeedSave = true
	toDelete := ref.(BaseElement)
...
/** Incoming **/
func (this *HumanPerformer_impl) GetIncomingPtr() []*Association{
	return this.m_incomingPtr
}

/** Init reference Incoming **/
func (this *HumanPerformer_impl) SetIncomingPtr(ref interface{}){
	this.NeedSave = true
	if refStr, ok := ref.(string); ok {
...
func (this *HumanPerformer_impl) RemoveIncomingPtr(ref interface{}){
	this.NeedSave = true
	toDelete := ref.(BaseElement)
...
/** GlobalTask **/
func (this *HumanPerformer_impl) GetGlobalTaskPtr() GlobalTask{
	return this.m_globalTaskPtr
}

/** Init reference GlobalTask **/
func (this *HumanPerformer_impl) SetGlobalTaskPtr(ref interface{}){
	this.NeedSave = true
	if _, ok := ref.(string); ok {
...
func (this *HumanPerformer_impl) RemoveGlobalTaskPtr(ref interface{}){
	this.NeedSave = true
	toDelete := ref.(BaseElement)
...
/** Process **/
func (this *HumanPerformer_impl) GetProcessPtr() *Process{
	return this.m_processPtr
}

/** Init reference Process **/
func (this *HumanPerformer_impl) SetProcessPtr(ref interface{}){
	this.NeedSave = true
	if _, ok := ref.(string); ok {
...
func (this *HumanPerformer_impl) RemoveProcessPtr(ref interface{}){
	this.NeedSave = true
	toDelete := ref.(BaseElement)
...
/** Activity **/
func (this *HumanPerformer_impl) GetActivityPtr() Activity{
	return this.m_activityPtr
}

/** Init reference Activity **/
func (this *HumanPerformer_impl) SetActivityPtr(ref interface{}){
	this.NeedSave = true
	if _, ok := ref.(string); ok {
...
func (this *HumanPerformer_impl) RemoveActivityPtr(ref interface{}){
	this.NeedSave = true
	toDelete := ref.(BaseElement)
