...
func (this *PotentialOwner) RemoveExtensionElements(ref interface{}){
	this.NeedSave = true
...
func (this *PotentialOwner) RemoveExtensionDefinitions(ref interface{}){
	this.NeedSave = true
...
func (this *PotentialOwner) RemoveExtensionValues(ref interface{}){
	this.NeedSave = true
