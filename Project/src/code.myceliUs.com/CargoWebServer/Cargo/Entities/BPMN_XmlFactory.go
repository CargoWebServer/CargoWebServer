...
//	object.M_other= xmlElement.M_other
	...
	/** Init formalExpression **/
	if xmlElement.M_timeDate!= nil{
		if object.M_timeDate== nil{
			object.M_timeDate= new(BPMN20.FormalExpression)
		}
	this.InitFormalExpression((*BPMN20.XsdFormalExpression)(unsafe.Pointer(xmlElement.M_timeDate)),object.M_timeDate)

		/** association initialisation **/
		object.M_timeDate.SetTimerEventDefinitionPtr(object)
	}

	/** Init formalExpression **/
	if xmlElement.M_timeDuration!= nil{
		if object.M_timeDuration== nil{
			object.M_timeDuration= new(BPMN20.FormalExpression)
		}
	this.InitFormalExpression((*BPMN20.XsdFormalExpression)(unsafe.Pointer(xmlElement.M_timeDuration)),object.M_timeDuration)

		/** association initialisation **/
		object.M_timeDuration.SetTimerEventDefinitionPtr(object)
	}

	/** Init formalExpression **/
	if xmlElement.M_timeCycle!= nil{
		if object.M_timeCycle== nil{
			object.M_timeCycle= new(BPMN20.FormalExpression)
		}
	this.InitFormalExpression((*BPMN20.XsdFormalExpression)(unsafe.Pointer(xmlElement.M_timeCycle)),object.M_timeCycle)

		/** association initialisation **/
		object.M_timeCycle.SetTimerEventDefinitionPtr(object)
	}
	if len(object.M_id) > 0 {
		this.m_references[object.M_id] = object
	}
...
//	xmlElement.M_other= object.M_other.(string)
	...
	/** Serialyze FormalExpression **/
	if object.M_timeDate!= nil {
		xmlElement.M_timeDate= new(BPMN20.XsdTimeDate)
	}

	/** Now I will save the value of timeDate **/
	if object.M_timeDate!=nil{
		this.SerialyzeFormalExpression((*BPMN20.XsdFormalExpression)(unsafe.Pointer(xmlElement.M_timeDate)),object.M_timeDate)
	}

	/** Serialyze FormalExpression **/
	if object.M_timeDuration!= nil {
		xmlElement.M_timeDuration= new(BPMN20.XsdTimeDuration)
	}

	/** Now I will save the value of timeDuration **/
	if object.M_timeDuration!=nil{
		this.SerialyzeFormalExpression((*BPMN20.XsdFormalExpression)(unsafe.Pointer(xmlElement.M_timeDuration)),object.M_timeDuration)
	}

	/** Serialyze FormalExpression **/
	if object.M_timeCycle!= nil {
		xmlElement.M_timeCycle= new(BPMN20.XsdTimeCycle)
	}

	/** Now I will save the value of timeCycle **/
	if object.M_timeCycle!=nil{
		this.SerialyzeFormalExpression((*BPMN20.XsdFormalExpression)(unsafe.Pointer(xmlElement.M_timeCycle)),object.M_timeCycle)
	}
	if len(object.M_id) > 0 {
		this.m_references[object.M_id] = object
	}
