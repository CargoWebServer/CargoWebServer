...
/*func TestHelloJerry(t *testing.T) {
	...
	engine.AppendJsFunction("SayHelloTo", []string{"toto"}, "function SayHelloTo(to){return 'Hello ' + to + '!';}")
...
func TestNumericValue(t *testing.T) {
	...
	// Create a remote javascript server.
	engine := GoJerryScriptClient.NewClient("127.0.0.1", 8081)
	engine.AppendJsFunction("Add", []string{"a", "b"}, "function Add(a, b){return a + b;}")
...
func TestBooleanValue(t *testing.T) {
	...
	engine.AppendJsFunction("TestBool", []string{"val"}, "function TestBool(val){return val>0;}")
...
func TestArray(t *testing.T) {
	...
	engine.AppendJsFunction("TestArray", []string{"arr, val"}, "function TestArray(arr, val){arr.push(val); return arr;}")
...
func TestGoFunction(t *testing.T) {
	...
	engine.AppendJsFunction("TestAddNumber", []string{}, `function TestAddNumber(){var result = AddNumber(3, 8); Print("The result is:" + result); return result;}`)
...
func TestGoObject(t *testing.T) {
	...
	engine.AppendJsFunction("TestJsToGoStruct", []string{}, `function TestJsToGoStruct(){var jerry = {TYPENAME:"GoJerryScript.Person", FirstName:"Jerry", LastName:"Script", Age:20, NickNames:["toto", "titi", "tata"]}; return jerry; }`)
